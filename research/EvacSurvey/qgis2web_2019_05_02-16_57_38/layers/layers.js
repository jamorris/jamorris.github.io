...
lyr_ZipCodeFlorida.setVisible(false);lyr_Evac_R2.setVisible(true);
...
lyr_ZipCodeFlorida.set('fieldLabels', {'ZCTA5CE10': 'no label', 'GEOID10': 'no label', 'CLASSFP10': 'no label', 'MTFCC10': 'no label', 'FUNCSTAT10': 'no label', 'ALAND10': 'no label', 'AWATER10': 'no label', 'INTPTLAT10': 'no label', 'INTPTLON10': 'no label', });
lyr_Evac_R2.set('fieldLabels', {'field_1': 'no label', 'ZIP_Code': 'inline label', 'Evac': 'inline label', 'NoEvac': 'inline label', 'total': 'inline label', 'city': 'no label', 'state': 'no label', 'latitude': 'no label', 'longitude': 'no label', });
