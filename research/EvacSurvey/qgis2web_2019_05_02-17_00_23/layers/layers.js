...
lyr_Evac_R2.set('fieldLabels', {'field_1': 'no label', 'ZIP_Code': 'header label', 'Evac': 'inline label', 'NoEvac': 'inline label', 'total': 'inline label', 'city': 'no label', 'state': 'no label', 'latitude': 'no label', 'longitude': 'no label', });
